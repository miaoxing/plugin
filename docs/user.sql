...
CREATE TABLE `user` (
  ...
  `status` mediumint(6) NOT NULL DEFAULT '0' COMMENT '二进制状态位,废弃',
  ...
  `area` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `lastPaidTime` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `mobileVerifiedAt` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '手机校验时间',
