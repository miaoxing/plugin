...
* feat(reqQuery)!: 增加 `setReqSearch` 方法来设置允许搜索的字段条件 ([ccbdf0c](https://github.com/miaoxing/plugin/commit/ccbdf0c0a333f16575b36603033e8fe2a700630b))
* refactor(reqQuery)!: 更改方法名称，移除不适合的方法 ([0150692](https://github.com/miaoxing/plugin/commit/01506927d77c729e1d3bc44cec202e50018cae3b))
* refactor!: 区域由 `area` 改为 `district` ([3ede966](https://github.com/miaoxing/plugin/commit/3ede966c509caefff939d829a2dda5dadb8e308c))
* refactor(app)!: 改为使用 `id` 作为应用标识 ([3ca0758](https://github.com/miaoxing/plugin/commit/3ca07584ba5fca0bdce942b04b877dacb30a957d))
* refactor(plugin)!: 存储插件编号由 JSON 格式改为逗号隔开 ([6b67d66](https://github.com/miaoxing/plugin/commit/6b67d66ea06d807915e9c0c66c2b708d57c0a4d9))
* refactor(Model)!: 整理属性转换逻辑，通过 `setAttributeFrom*` 和 `convertTo*Attribute` 方法处理属性 ([b4e7a46](https://github.com/miaoxing/plugin/commit/b4e7a46cc3e727e721d9242da27a47dcc20ea219))
* refactor(Model)!: 模型 `__invoke` 方法整理 ([c680dd9](https://github.com/miaoxing/plugin/commit/c680dd9be75d2a3975ecf5afb49645db787651d9))
* refactor(Model)!: `CastTrait` 和 `DefaultScopeTrait` 作为内置功能加入 `ModelTrait` 中 ([c13200f](https://github.com/miaoxing/plugin/commit/c13200f39b842c4be834ddcf465b19861ba3346d))
* refactor(Model)!: 调整关联相关逻辑 ([e5a9f20](https://github.com/miaoxing/plugin/commit/e5a9f20a8d505621cf67612821f8748695e8886b))
* refactor(Model)!: 整理事件相关逻辑 ([199ae29](https://github.com/miaoxing/plugin/commit/199ae29d18b94efc1c1239de42c3215e64edb84e))
* refactor(Model)!: 整理服务相关逻辑 ([ec3baf7](https://github.com/miaoxing/plugin/commit/ec3baf7983b33c9e85031c197ece5c7425387210))
* refactor(Model)!: 整理模型方法 ([d753ab4](https://github.com/miaoxing/plugin/commit/d753ab4fda472fabe040f451d3535e97ddcec014))
* refactor(Test)!: `assertRetErr` 的 `code` 和 `message` 参数对换 ([ccd308c](https://github.com/miaoxing/plugin/commit/ccd308ceb260e87115cb269cb86be419a419f701))
* refactor(Model)!: 方法增加类型和返回值 ([4da0bf7](https://github.com/miaoxing/plugin/commit/4da0bf7ab2aa8c8a497d2c78a737172cba9c28ca))
* refactor(Model)!: 关联逻辑整理 ([9a01667](https://github.com/miaoxing/plugin/commit/9a01667b7e72a554d53647217a2490acf6fe4ead))
* refactor(Model)!: `changes` 属性逻辑整理 ([92cbe14](https://github.com/miaoxing/plugin/commit/92cbe14cbc85e4f641ee7d1f934195e5a9064bfe))
* refactor(Model)!: `preExecute` 事件改为 `beforeExecute`，`preBuildQuery` 事件改为 `beforeAddQueryPart` ([1357e09](https://github.com/miaoxing/plugin/commit/1357e091a4f00f4ff8a8485c117effd129ec6bbf))
* refactor(Model)!: 整理获取和设置属性的逻辑 ([3e16fd6](https://github.com/miaoxing/plugin/commit/3e16fd6a9a13de2fcbb06baea1bc8b427f219ce4))
* feat(Model)!: 增加自动从数据库读取字段默认值 ([bd4bef5](https://github.com/miaoxing/plugin/commit/bd4bef50b1bd8c081cfc7bb8575ea978bab445fe))
* feat(Model)!: 类型转换将不能为 `null` 的值转换为对应的类型 ([225d392](https://github.com/miaoxing/plugin/commit/225d39271127f58ab94e12c1ab80ec808e499741))
* refactor(Model)!: `getColumns` 方法改为返回二级数组，键名为数据表字段名，值为字段配置，如 `cast` ([59886df](https://github.com/miaoxing/plugin/commit/59886df55c51d5dcb9ed8f856f523fb4ef4ed22f))
* refactor(Model)!: 移除历史遗留的 `findOne` 和 `findAllByIds` 方法 ([3f9940c](https://github.com/miaoxing/plugin/commit/3f9940c90030c0ef91d3a6d9cdfa4af993a34000))
* refactor(QueryBuilder)!: `add` 方法改名为 `addQueryPart` ([e124904](https://github.com/miaoxing/plugin/commit/e1249047f67802ae1aff1076a5f6ded7e0cc9d86))
* refactor(QueryBuilder)!: 整理 `queryParams` 逻辑 ([36e900c](https://github.com/miaoxing/plugin/commit/36e900c4a11564bbfced56956e876f7fa7e7154d))
* refactor(Model)!: 移除自动加载和 `loaded` 属性 ([0212a9c](https://github.com/miaoxing/plugin/commit/0212a9c6ad1b5af4d403b3fb955e5c8f615addca))
* refactor(Model)!: 拆分出 `CollTrait` ([8c138af](https://github.com/miaoxing/plugin/commit/8c138af163012163f68dff002b1284366d479fb5))
* refactor(Model)!: `data` 属性改为 `attributes`，相关属性和方法更新 ([8f74a53](https://github.com/miaoxing/plugin/commit/8f74a53b0308b5301446bc924135d1ed3d4c9795))
* refactor(Model)!: 移除 `detach` 和 `isDestroyed` 属性的相关功能 ([148e5d8](https://github.com/miaoxing/plugin/commit/148e5d85155f070eb82ccc06941e94aa8be2105b))
* refactor(Model)!: 移除 `isChanged` 属性，直接使用 `isChanged()` 方法 ([6828ed3](https://github.com/miaoxing/plugin/commit/6828ed3bbd74f89f498f77564e02ced43fb10039))
* refactor(QueryBuilder)!: 允许直接调用 `setCacheKey` 或 `setCacheTags` 来启用缓存 ([51b6423](https://github.com/miaoxing/plugin/commit/51b64236657d7e027a892560464c5ffb4856bd5e))
* refactor(Model)!: 列表返回数据中 `rows` 改为 `limit`，`records` 改为 `total` ([00d1ea7](https://github.com/miaoxing/plugin/commit/00d1ea7a8e42ee6314f4c8989fcdfd399f441093))
* refactor!: `Service/Model` 拆分出 `ModelTrait`, 改名为 `BaseModel` ([a29bae7](https://github.com/miaoxing/plugin/commit/a29bae796895c78ccf1debee803793c5ba87d80c))
* refactor(Model)!: Model 列名都改为驼峰格式，与数据库交互转换为下划线格式 ([92be472](https://github.com/miaoxing/plugin/commit/92be47278af2f238bf8d301c7bb1e7b6e58685c1))
* refactor!: 同步数据库迁移语句更改 ([18c8597](https://github.com/miaoxing/plugin/commit/18c8597e0ca4ebe5e422417f832782cb51f7b7d7))
* refactor(config)!: 默认的数据表前缀加上 `mx_` ([5118532](https://github.com/miaoxing/plugin/commit/5118532a684c11901a357ff9f263b4a71ba9f75c))
